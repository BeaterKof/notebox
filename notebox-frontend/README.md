...
## logging
A user is logged in if the session storage contains an email address and a JWT token. (set in the Login.js component)


## manual testing:
0. Create account with bad email/password
1. Create account -> try creating it again with same email address
2. Login/Logout (with valid/invalid email/password) 
3. Create/modify/delete notes (with valid/invalid title)
4. Check notes ordering
5. Check notes search by string
6. Check paging
7. Change password
8. Kill backend before and after login
